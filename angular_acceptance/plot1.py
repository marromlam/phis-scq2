...
def argument_parser():
  ...
  parser.add_argument('--original', default = f'/scratch17/marcos.romero/phis_samples/2016/MC_Bs2JpsiPhi/v0r5.root',
                      help='File to correct')
  parser.add_argument('--weights', default = f'/scratch17/marcos.romero/phis_samples/2016/MC_Bs2JpsiPhi/v0r5_angWeight.root',
                      help='File to correct')
  parser.add_argument('--target', default = f'/scratch17/marcos.romero/phis_samples/2016/Bs2JpsiPhi/v0r5.root',
                      help='File to correct')
  ...
  parser.add_argument('--branch', default='B_P',
                      help='Name of the target tree')
  parser.add_argument('--kkpweighted', default='output_new/figures/reweightings/2016/MC_Bs2JpsiPhi/v0r5_B_P_kkpWeight.pdf',
...
if __name__ == '__main__':
  ...
  kkp = ipanema.Sample.from_root(args['weights'],treename='2015&2016&2017&2018')
  var = args['branch']
  var = 'hplus_P'
