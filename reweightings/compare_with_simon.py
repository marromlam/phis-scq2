...
# and new ones are at:
new_path = '/scratch17/marcos.romero/phis_samples/v0r2'

# Create some paths
os.makedirs('output/reweightings/2016', exist_ok=True )
os.makedirs('output/reweightings/2015', exist_ok=True )
...
for y in ['2015','2016']:
  ...
  for m in ['Bd2JpsiKstar', 'MC_Bs2JpsiPhi_dG0', #'MC_Bs2JpsiPhi',
    ...
    new[y][m] = Sample.from_root(os.path.join(t_n_p,m,'test.root'))
...
for year in  [2015, 2016]:
  ...
  try:
    ...
    axpull.plot(n.bins,0*n.pulls)
    axpull.fill_between(n.bins,1*n.pulls,0*n.pulls)
    ...
    axplot.legend()
    fig.savefig(f'output/reweightings/{year}/MC_Bs2JpsiPhi_pdfWeight.pdf')
  except:
    print(f'Failed in output/reweightings/{year}/MC_Bs2JpsiPhi_pdfWeight.pdf')
  try:
    fig, axplot, axpull = ipanema.plotting.axes_plotpull()
    ...
    axplot.set_ylabel('Events')
    axplot.legend()
    fig.savefig(f'output/reweightings/{year}/MC_Bs2JpsiPhi_dG0_pdfWeight.pdf')
  except:
    print(f'Failed in output/reweightings/{year}/MC_Bs2JpsiPhi_pdfWeight.pdf')
  try:
    fig, axplot, axpull = ipanema.plotting.axes_plotpull()
    ...
    axplot.set_ylabel('Events')
    axplot.legend()
    fig.savefig(f'output/reweightings/{year}/MC_Bd2JpsiKstar_pdfWeight.pdf')
  except:
    print(f'Failed in output/reweightings/{year}/MC_Bs2JpsiPhi_pdfWeight.pdf')
  ...
  #%% pdfWeight
  fig, axplot, axpull = ipanema.plotting.axes_plotpull()
  o, n = histogram.compare_hist([old[f'{year}']['MC_Bs2JpsiPhi_dG0'].df['pdfWeight'],new[f'{year}']['MC_Bs2JpsiPhi_dG0'].df['pdfWeight']],range=(0,2))
  axplot.plot(o.bins,o.counts,drawstyle='steps-mid',label='Heidelberg')
  axplot.plot(n.bins,n.counts,drawstyle='steps-mid',ls='-.',label='Santiago')
  axpull.plot(n.bins,0*n.pulls)
  axpull.fill_between(n.bins,1*n.pulls,0*n.pulls)
  ...
  fig, axplot, axpull = ipanema.plotting.axes_plotpull()
  o, n = histogram.compare_hist([old[f'{year}']['MC_Bd2JpsiKstar'].df['pdfWeight'],new[f'{year}']['MC_Bd2JpsiKstar'].df['pdfWeight']],range=(0,2))
  axplot.plot(o.bins,o.counts,drawstyle='steps-mid',label='Heidelberg')
  axplot.plot(n.bins,n.counts,drawstyle='steps-mid',ls='-.',label='Santiago')
  axpull.plot(n.bins,0*n.pulls)
  axpull.fill_between(n.bins,1*n.pulls,0*n.pulls)
  ...
  #%% kinWeight
  fig, axplot, axpull = ipanema.plotting.axes_plotpull()
  o, n = histogram.compare_hist([old[f'{year}']['MC_Bs2JpsiPhi_dG0'].df['kinWeight'],new[f'{year}']['MC_Bs2JpsiPhi_dG0'].df['kinWeight']],range=(0,2))
  axplot.plot(o.bins,o.counts,drawstyle='steps-mid',label='Heidelberg')
  axplot.plot(n.bins,n.counts,drawstyle='steps-mid',ls='-.',label='Santiago')
  axpull.plot(n.bins,0*n.pulls)
  axpull.fill_between(n.bins,1*n.pulls,0*n.pulls)
  ...
  axplot.set_ylabel('Events')
  axplot.legend()
  fig.savefig(f'output/reweightings/{year}/MC_Bs2JpsiPhi_dG0_kinWeight.pdf')

  fig, axplot, axpull = ipanema.plotting.axes_plotpull()
  o, n = histogram.compare_hist([old[f'{year}']['MC_Bd2JpsiKstar'].df['kinWeight'],new[f'{year}']['MC_Bd2JpsiKstar'].df['kinWeight']],range=(0,2))
  axplot.plot(o.bins,o.counts,drawstyle='steps-mid',label='Heidelberg')
  axplot.plot(n.bins,n.counts,drawstyle='steps-mid',ls='-.',label='Santiago')
  axpull.plot(n.bins,0*n.pulls)
  axpull.fill_between(n.bins,1*n.pulls,0*n.pulls)
  ...
  axplot.set_ylabel('Events')
  axplot.legend()
  fig.savefig(f'output/reweightings/{year}/MC_Bd2JpsiKstar_kinWeight.pdf')
  ...
  axplot.set_ylabel('Events')
  axplot.legend()
  fig.savefig(f'output/reweightings/{year}/Bd2JpsiKstar_kinWeight.pdf')
