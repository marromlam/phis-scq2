...
# Lists of data variables to load and build arrays
    ...
    for i, y in enumerate(YEARS):
        ...
        for t in TRIGGER:
            ...
            data[y][t] = Sample.from_root(args['samples'].split(
                ',')[i], branches=branches_to_load, cuts=tc)
...
# Prepare parameters {{{
    ...
    list_of_parameters = [
        ...
        Parameter("eta_os", value=data[str(
            YEARS[0])][TRIGGER[0]].flavor['eta_os'].value, free=False),
        Parameter("eta_ss", value=data[str(
            YEARS[0])][TRIGGER[0]].flavor['eta_ss'].value, free=False),
        Parameter("p0_os",  value=data[str(
            YEARS[0])][TRIGGER[0]].flavor['p0_os'].value,  free=True, min=0.0, max=1.0, latex="p^{\rm OS}_{0}"),
        Parameter("p1_os",  value=data[str(
            YEARS[0])][TRIGGER[0]].flavor['p1_os'].value,  free=True, min=0.5, max=1.5, latex="p^{\rm OS}_{1}"),
        Parameter("p0_ss",  value=data[str(
            YEARS[0])][TRIGGER[0]].flavor['p0_ss'].value,  free=True, min=0.0, max=2.0, latex="p^{\rm SS}_{0}"),
        Parameter("p1_ss",  value=data[str(
            YEARS[0])][TRIGGER[0]].flavor['p1_ss'].value,  free=True, min=0.0, max=2.0, latex="p^{\rm SS}_{1}"),
        Parameter("dp0_os", value=data[str(YEARS[0])][TRIGGER[0]].flavor['dp0_os'].value,
                  free=True, min=-0.1, max=0.1, latex="\Delta p^{\rm OS}_{0}"),
        Parameter("dp1_os", value=data[str(YEARS[0])][TRIGGER[0]].flavor['dp1_os'].value,
                  free=True, min=-0.1, max=0.1, latex="\Delta p^{\rm OS}_{1}"),
        Parameter("dp0_ss", value=data[str(YEARS[0])][TRIGGER[0]].flavor['dp0_ss'].value,
                  free=True, min=-0.1, max=0.1, latex="\Delta p^{\rm SS}_{0}"),
        Parameter("dp1_ss", value=data[str(YEARS[0])][TRIGGER[0]].flavor['dp1_ss'].value,
                  free=True, min=-0.1, max=0.1, latex="\Delta p^{\rm SS}_{1}"),
    ]
