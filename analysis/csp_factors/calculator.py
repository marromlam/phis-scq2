...
f0_Syr = flatte(mass, m0_flatte, gPiPi, gKK, Mpip, Mpi0, MKp, MK0)
...
phi2KK_EvtGen = Breit_Wigner(mass, m0_bwigner, g0_bwigner, mKp, mKp, 1)
...
#         xgev = mvar*1e-03
#
#         dd = ((SR_S.Eval(xgev)*SR_S.Eval(xgev) + SI_S.Eval(xgev) *
#               SI_S.Eval(xgev))*PSs_n*PSs_n)  # re(f2.subs(mass,mvar).n())
