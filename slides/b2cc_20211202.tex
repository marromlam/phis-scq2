...
\newcommand{\TalkAuthorShort}{V. G. Chobanova, Diego Martínez, M. Romero, R. A. Ruiz}
\newcommand{\TalkTitle}{$\phi_s$ between\\ SCQ and CAG}
\newcommand{\TalkTitleShort}{$\phi_s$ between Santiago and Cagliari}
\newcommand{\TalkInstitute}{}
\newcommand{\TalkDate}{December 2nd}
\newcommand{\TalkDateNumber}{2021/12/02}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Define box and box title style
\tikzstyle{mybox} = [draw=red, fill=red!0, very thick,
