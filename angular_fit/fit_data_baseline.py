...
mc_std = Sample.from_root(f'{path}/{year}/{mode}/test.root')
#mc_std.assoc_params(Parameters.load(f'angular_acceptance/params/{year}/MC_Bs2JpsiPhi.json'))
mc_dg0 = Sample.from_root(f'{path}/{year}/{mode}/test.root')
#mc_dg0.assoc_params(Parameters.load(f'angular_acceptance/params/{year}/MC_Bs2JpsiPhi_dG0.json'))
...
list_of_parameters = [#
Parameter(name='fSlon1', value=SWAVE*0.4260, min=0.20, max=0.60, free=SWAVE),
Parameter(name='fSlon2', value=SWAVE*0.0590, min=0.00, max=0.60, free=SWAVE),
Parameter(name='fSlon3', value=SWAVE*0.0101, min=0.00, max=0.60, free=SWAVE),
Parameter(name='fSlon4', value=SWAVE*0.0103, min=0.00, max=0.60, free=SWAVE),
Parameter(name='fSlon5', value=SWAVE*0.0490, min=0.00, max=0.60, free=SWAVE),
Parameter(name='fSlon6', value=SWAVE*0.1930, min=0.10, max=0.60, free=SWAVE),
#
Parameter(name="fPlon", value=0.5241, min=0.4, max=0.6, latex=r'f_0'),
Parameter(name="fPper", value=0.2500, min=0.2, max=0.3, latex=r'f_{\perp}'),
#
...
Parameter(name="dPlon", value=0.00, min=-2*np.pi, max=2*np.pi, free = False),
